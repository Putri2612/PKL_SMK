...
class TugasSiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        $kelas = $siswa->Kelas;  
        $tugas = $kelas->Tugas;          
        $tahun_ajar = $kelas->tahun_ajar->nama;    
        return view('siswa.tugas.indexSelect', [
            'title' => 'Data Tugas',
            'plugin' => '
            ...
            'siswa' => Siswa::firstWhere('id', session('siswa')->id),
            'tugas' => Tugas::select('mapel_id')->where('kelas_id', session('siswa')->kelas_id)->groupByRaw('mapel_id')->get(),
