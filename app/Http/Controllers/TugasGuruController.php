...
class TugasGuruController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('guru.tugas.indexSelect', [
            'title' => 'Data Tugas',
            'plugin' => '
            ...
            'tugas' => Tugas::select('mapel_id')->where('guru_id', session('guru')->id)->groupByRaw('mapel_id')->get()
        ]);
    }
    ...
    public function index_select($kode)
    {
        ...
        return view('guru.tugas.index', [
            ...
            'guru' => Guru::firstWhere('id', session('guru')->id),
            'tugas' => Tugas::where('mapel_id', $kode)->get(),
            'tahun_ajar' => $tahun_ajar_aktif,
        ]);
    }
