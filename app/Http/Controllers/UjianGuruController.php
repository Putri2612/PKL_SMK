...
class UjianGuruController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('guru.ujian.indexSelect', [
            'title' => 'Data Ujian',
            'plugin' => '
            ...
            'ujian' => Ujian::select('mapel_id')->where('guru_id', session('guru')->id)->groupByRaw('mapel_id')->get()
        ]);
    }
    ...
    public function index_select($kode)
    {
        ...
        return view('guru.ujian.index', [
            ...
            'guru' => Guru::firstWhere('id', session('guru')->id),
            'tahun_ajar' => $tahun_ajar_aktif,
            'ujian' => Ujian::where('mapel_id', $kode)->get()
        ]);
    }
