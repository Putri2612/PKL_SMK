...
<head>
    ...
    <title>SMAN 20 SURABAYA | {{ $title }}</title>
    <link rel="icon" type="image/x-icon" href="{{ url('/assets/img') }}/logosman20.png" />
                            ...
                            <div class="media mx-auto">
                                ...
                                @if (session('dudi'))
                                    <div class="media-body">
                                        ...
                                        <p>MITRA DU/DI SMKN 1 BRONDONG</p>
                                    </div>
                                    @php
                                        $link_profile = '/dudi/profile';
                                    @endphp
                                @endif
                                @if (session('siswa'))
                                    <div class="media-body">
                                        <h5>{{ $siswa->nama_siswa }}</h5>
                                        <p>SISWA SMKN 1 BRONDONG</p>
                                    </div>
                                    @php
