            ...
            <div class="col-lg-12 layout-spacing">
                <div class="widget shadow">
                    <div class="widget-content-area">
                                ...
                                <div class="widget shadow p-3">
                                    ...
                                    @if ($tugas_siswa != null)
                                        ...
                                        @if ($tugas_siswa->date_send === null)
                                            ...
                                            <a href="{{ url('/siswa/km_tugas/kerjakan/' . $tugas_siswa->id) }}" class="btn btn-primary btn-kerjakan">Kerjakan</a>
                                        ...
                                        @else
                                            ...
                                            @if ($tugas_siswa->nilai === null)
                                                <a href="{{ url("/siswa/km_tugas/" . $tugas_siswa->kode . '/edit') }}" class="btn btn-primary btn-sm btn-kerjakan">lihat / edit jawaban</a>
                                            @else
                                                <a href="{{ url("/siswa/km_tugas/" . $tugas_siswa->kode . '/edit') }}" class="btn btn-primary btn-sm btn-kerjakan">lihat jawaban</a>
                                            @endif
                        ...
                        <a href="javascript:void(0);" onclick="history.back();" class="btn btn-primary mt-3">Kembali</a>
                        {{-- <a href="{{ url("/siswa/km_tugas") }}" class="btn btn-danger btn-sm mt-3"><span data-feather="arrow-left-circle"></span> Kembali</a> --}}
                    </div>
                </div>
            </div>
        </div>
