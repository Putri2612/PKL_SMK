                                ...
                                <div class="widget-footer pl-2 py-2 mt-3" style="border-top: 1px solid #e0e6ed; font-weight: bold;">
                                    ...
                                    <div class="table-responsive" style="overflow-x: scroll;">
                                        <table class="text-nowrap">
                                            ...
                                            @endphp
                                            <tr>
                                                <th>Benar : <span class="badge badge-success mr-1 mt-1">{{ $benar }}</span> | Salah : <span class="badge badge-danger mr-1 mt-1">{{ $salah }}</span> | Tidak Dijawab : <span class="badge btn-white mt-1">{{ $tidakDijawab }}</span> | Nilai : <span class="badge badge-primary">{{ round($nilai) }}</span></th>
                                            </tr>
                                        </table>
                                    </div>
                                    {{-- <table>
