                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sesi as $s)
                                            <tr>
                                                ...
                                                <td>{{  $s->nama_sesi }}</td>
                                                <td>{{  $s->deskripsi }}</td>
                                                <td>{{  $s->tahun_ajar->nama }}</td>
                                                <td>
                                                    <a href="{{ url('/admin/relasi_sesi') }}/{{ $s->id }}" class="btn btn-primary btn-sm">
                                                        <span data-feather="link"></span>
                                                    </a>
                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#edit_sesi" data-id_sesi="{{ $s->id }}" data-nama_sesi="{{ $s->nama_sesi }}" data-deskripsi="{{ $s->deskripsi }}" data-tahun_ajar_id="{{ $s->tahun_ajar->id }}" class="btn btn-primary btn-sm edit-sesi">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_sesi" id="id_sesi" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tahun_ajar_id" id="tahun_ajar_id" class="form-control">
                            ...
                            <option value="{{ $ta->id }}" {{ $ta->id == $s->tahun_ajar->id ? 'selected' : '' }}>
                                {{  $ta->nama }}
                            </option>
                             @endforeach
                        </select>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#edit_sesi').on('show.bs.modal', function(event) {
            ...
            var namaSesi = button.data('nama_sesi');
            var deskripsi = button.data('deskripsi');
            var tahunAjarID = button.data('tahun_ajar_id');
            var idSesi = button.data('id_sesi');
            var modal = $(this);
            modal.find('#id_sesi').val(idSesi);
            modal.find('#nama_sesi').val(namaSesi);
