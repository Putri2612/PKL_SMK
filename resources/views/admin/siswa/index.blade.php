                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($siswa as $s)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#edit_siswa" data-siswa="{{ $s->nisn }}" class="btn btn-primary btn-sm edit-siswa">
                                                        <i data-feather="edit"></i>
                                                    </a>
                                                    <a href="{{ url("/admin/hapus_siswa") }}/{{ $s->nisn }}" class="btn btn-danger btn-sm btn-hapus">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="tbody-siswa">
                            <tr>
                                <td><input type="text" name="nisn[]" required style="border: none; background: transparent; width: 100%; height: 100%;"></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nisn" id="nisn" value="{{ old('nisn') }}" class="form-control" readonly>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#tbody-siswa").on("click","tr td button",function(){$(this).parents("tr").remove()}),
        $(".edit-siswa").click(function(){var a=$(this).data("siswa");$.ajax({type:"get",data:{nisn:a},dataType:"json",async:!0,url:"{{ route('ajaxsiswa') }}",success:function(a){$("#nisn").val(a.nisn),$("#nama_siswa").val(a.nama_siswa),$("#kelas_id").val(a.kelas_id),$("#jurusan_id").val(a.jurusan_id),$("#active").val(a.is_active)}})}),
