                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="widget-heading">
                                <h5 class="">Kelompok PKL - {{ $jurusan -> nama_jurusan }}</h5>
                            </div>
                                {{-- <a href="{{ url("/admin/ekspor_kelompok") }}" class="btn btn-warning btn-sm mt-3" target="_blank">
                                ...
                                <table id="datatable-table" class="table text-nowrap">
                                    ...
                                    @foreach ($kelompokData as $kelompok)
                                        <tr>
                                            ...
                                            <td>{{ $kelompok->tahun_ajar->nama }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                </table>
                        ...
                        <a href="{{ url("/admin/kelompok") }}" class="btn btn-primary mt-3">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
