                                        ...
                                        <tbody>
                                            @foreach ($guru as $g)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#edit_guru" data-guru="{{ $g->nip }}" class="btn btn-primary btn-sm edit-guru">
                                                            <i data-feather="edit"></i>
                                                        </a>
                                                        <a href="{{ url('/admin/hapus_guru') }}/{{ $g->nip }}" class="btn btn-danger btn-sm btn-hapus">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="">NIP</label>
                            <input type="text" name="nip" id="nip" value="{{ old('nip') }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" id="role" class="form-control">
                                <option value="">pilih</option>
                                @foreach ($guruRoles as $guruRole)
                                    <option value="{{ $guruRole['id'] }}" @if ($g->role === $guruRole['id']) selected @endif>
                                        {{ $guruRole['name'] }}
                                    </option>
                                @endforeach
                            </select>
        ...
        $(document).ready(function() {
            ...
            $('.tambah-baris-guru').click(function() {
                const guru = `
                    <tr>
                        <td>
                            <input type="text" name="nip[]" required style="border: none; background: transparent; width: 100%; height: 100%;">
                        </td>
                        <td>
                            <input type="text" name="nama_guru[]" required style="border: none; background: transparent; width: 100%; height: 100%;">
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text" name="email[]" required style="border: none; background: transparent; width: 100%; height: 100%;">
                        </td>
                        <td>
                                        <select name="role[]" required
                                            style="border: none; background: transparent; width: 100%; height: 100%;">
            ...
            $("#tbody-guru").on("click","tr td button",function(){$(this).parents("tr").remove()}),
            $(".edit-guru").click(function(){var e=$(this).data("guru");$.ajax({type:"get",data:{nip:e},dataType:"json",async:!0,url:"{{ route('ajaxguru') }}",success:function(e){$("#nip").val(e.nip),$("#nama_guru").val(e.nama_guru),$("#jurusan_id").val(e.jurusan_id),$("#email").val(e.email),$("#role").val(e.role),$("#active").val(e.is_active)}})}),
